...
val get_pos : Input.buffer -> Input.idx -> pos

(** Get a position from type Pos.t *)
val pos_of_spos : t -> pos
val interval_of_spos : t * t -> interval
...
val print_spos2    : ?style:style -> unit -> out_channel -> t * t    -> unit
